...
class WhenDailyRruleTest extends PHPUnit_Framework_TestCase
{
    ...
    function testDailyOne()
    {
        ...
        $occurences = $r->rule("FREQ=DAILY;COUNT=10")
          ->generate('U');
    ...
    function testDailyTwo()
    {
        ...
        $r = new When(new DateTime("19970902T090000"));
        $occurences = $r->rule("FREQ=DAILY;UNTIL=19971224T000000Z")
          ->generate('U');
    ...
    function testDailyThree()
    {
        ...
        $r = new When(new DateTime("19970902T090000"));
        $occurences = $r->rule("FREQ=DAILY;INTERVAL=2")
          ->generate('U');
    ...
    function testDailyFour()
    {
        ...
        $r = new When(new DateTime("19970902T090000"));
        $occurences = $r->rule("FREQ=DAILY;INTERVAL=10;COUNT=5")
          ->generate('U');
    ...
    function testDailyFive()
    {
        ...
        $r->rule("FREQ=DAILY;UNTIL=20000131T140000;BYMONTH=1")
          ->generate('U');
